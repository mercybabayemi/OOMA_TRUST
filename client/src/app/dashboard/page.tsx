        ...
        <div className="flex h-screen bg-gray-50 font-sans">
            ...
            <main className="flex-1 p-4 md:p-8 overflow-y-auto">
                ...
                {!isVerified ? (
                    ...
                    <div>
                        <div className="bg-blue-900 text-white rounded-xl p-8 mb-8 shadow-xl"><h2 className="font-bold text-3xl mb-2">You're All Set!</h2><p className="text-blue-200 mb-6 max-w-prose">Your identity is verified. You can now create your will, secure your assets, and protect your beneficiaries.</p><button className="bg-amber-400 text-blue-900 font-bold py-3 px-8 rounded-lg hover:bg-amber-300 transition-transform hover:scale-105">Write my Will</button></div>
